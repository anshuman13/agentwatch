---
description: Open the agentwatch dashboard (starts the local server if needed).
---

Start the agentwatch server if it is not already running, then report the URL.
